...
// in bloc_app/test/infrastructure/repositories/theme_local_repository_test.dart.
...
class MockThemeLocalDatasource extends _i1.Mock
  ...
  @override
  _i3.Future<bool> getChachedThemeData() => (super.noSuchMethod(
        Invocation.method(
          #getChachedThemeData,
          [],
        ),
  ...
  @override
  _i3.Future<void> setCacheThemeData({required bool? mode}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setCacheThemeData,
          [],
